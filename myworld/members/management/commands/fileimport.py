...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
      ...
      citydata = pd.read_csv('Case Maykin Media - Django - CSV data/city.csv',
                             names=['city_id', 'city_name'], sep=";", header=None)
      hoteldata = pd.read_csv('Case Maykin Media - Django - CSV data/hotel.csv', names=[
                              'city_id', 'hotel_id', 'hotel_name', '3'], sep=";", header=None)
